...
class ContenidoListFisicaScreen extends StatefulWidget {
  const ContenidoListFisicaScreen({Key? key}) : super(key: key);

  @override
  State<ContenidoListFisicaScreen> createState() =>
      _ContenidoListFisicaScreenState();
}

class _ContenidoListFisicaScreenState extends State<ContenidoListFisicaScreen> {
  /* Shared Preferences */
                        ...
                        child: Column(children: [
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (contenidoList[index].id_seccion == 2) {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title:
          /* AppbarTitle(text: "Física", margin: EdgeInsets.only(left: 21.h)) */
          Text("Física", style: theme.textTheme.headlineMedium),
    );
  }
