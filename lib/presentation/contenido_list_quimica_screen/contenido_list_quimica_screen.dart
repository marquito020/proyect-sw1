...
class ContenidoListQuimicaScreen extends StatefulWidget {
  const ContenidoListQuimicaScreen({Key? key}) : super(key: key);

  @override
  State<ContenidoListQuimicaScreen> createState() =>
      _ContenidoListQuimicaScreenState();
}

class _ContenidoListQuimicaScreenState
    extends State<ContenidoListQuimicaScreen> {
  /* Shared Preferences */
                        ...
                        child: Column(children: [
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (contenidoList[index].id_seccion == 5) {
