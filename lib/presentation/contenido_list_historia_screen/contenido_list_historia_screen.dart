...
class ContenidoListHistoriaScreen extends StatefulWidget {
  const ContenidoListHistoriaScreen({Key? key}) : super(key: key);

  @override
  State<ContenidoListHistoriaScreen> createState() =>
      _ContenidoListHistoriaScreenState();
}

class _ContenidoListHistoriaScreenState
    extends State<ContenidoListHistoriaScreen> {
  /* Shared Preferences */
                        ...
                        child: Column(children: [
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (contenidoList[index].id_seccion == 3) {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title:
            AppbarTitle(text: "Historia", margin: EdgeInsets.only(left: 21.h)));
  }
